...
<img width="574" height="682" alt="Screenshot 2025-10-02 at 10 25 36 AM" src="https://github.com/user-attachments/assets/06f12ea4-7f62-44e8-b7e0-f017e09e3e7b" />
...
## Question 39: What is a dSYM file?  
dSYM stands for Debug Symbols file. It is automatically generated by Xcode for every build of your app.  

**Purpose:** 
It maps the memory addresses in a crash log to readable function names, file names, and line numbers. Without it, crash logs only show hexadecimal addresses (like 0x100a34210) which are meaningless.  

**Why is it important?**  

**When an app crashes:**  

- Crash log shows raw memory addresses in stack trace
- You can’t tell which exact line of your code crashed
- dSYM lets Crashlytics or Xcode “symbolicate” the crash log → converts addresses to readable lines

**Example:**  

Without dSYM (unsymbolicated):  
...
**With dSYM (symbolicated):**  

```swift
0   MyApp  TransactionViewController.swift line 112
